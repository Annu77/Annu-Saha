...
import annu from "../assets/annu.webp";
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(heroRef.current.querySelector(".hero-title"), {
        ...
        .from(
          heroRef.current.querySelector(".hero-subheading"),
          {
            opacity: 0,
            y: 50,
            scale: 0.95,
        ...
        .from(
          heroRef.current.querySelector(".hero-img"),
          {
            opacity: 0,
            y: 100,
            scale: 0.9,
  ...
  return (
    ...
    >
      <div className="mt-8 lg:mt-20">
        <h1 className="hero-title text-4xl uppercase lg:text-7xl lg:mt-7">
          {PROFILE.name}
        </h1>
